...
import India from './assets/india2.svg';
import Butt1 from './assets/butt1.svg';
import Butt2 from './assets/butt2.svg';
import Butt3 from './assets/butt3.svg';
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <img className="butt1" src={Butt1} alt="" />
        <img className="butt3" src={Butt2} alt="" />
        <img className="butt2" src={Butt3} alt="" />
        ...
        <div className="weekly">
          <div className="weekly-item" style={{ "backgroundColor": "#449B9D" }}>
          ...
          <div className="weekly-item" style={{ "backgroundColor": "#BB8F9D" }}>
            <Weather />
          </div>
          <div className="weekly-item" style={{ "backgroundColor": "#95CBC9" }}>
